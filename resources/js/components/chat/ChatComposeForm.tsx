...
import ChatRecipientInput from "@/components/chat/ChatRecipientInput"
import RichTextEditor from "@/components/rich-text-editor"
import { Button } from "@/components/ui/button"
import { Spinner } from "@/components/ui/spinner"
import Axios from "@/lib/axios"
import toast from "@/lib/toast"
import { useReplyChat, useSendChat } from "@/queries/chat"
import type { ChatComposeMode } from "@/types/chat"
...
export default function ChatComposeForm({
	...
	const replyChat = useReplyChat(
		mode === "new" ? "reply" : mode,
		parentMessageId ?? ""
	)

	const mutation = mode === "new" ? sendChat : replyChat
